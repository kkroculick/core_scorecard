...
/**
 * ScorecardWebform generated by hbm2java
 */
@Entity
@Table(name="scorecard_webform"
    ,schema="public"
)
public class ScorecardWebform  implements java.io.Serializable
 {
...
private Integer employeeId;
    ...
    @Column(name="aet_investment_status_score", precision=17, scale=17)
    ...
    @Column(name="aet_investment_status_weight", precision=17, scale=17)
    ...
    @Column(name="number_component_technical_debt", precision=17, scale=17)
    ...
    @Column(name="number_component_technical_debt_score", precision=17, scale=17)
    ...
    @Column(name="number_component_technical_debt_weight", precision=17, scale=17)
    ...
    @Column(name="number_implemented_initiatives", precision=17, scale=17)
    ...
    @Column(name="number_implemented_initiatives_score", precision=17, scale=17)
    ...
    @Column(name="number_implemented_initiatives_weight", precision=17, scale=17)
    ...
    @Column(name="number_platforms", precision=17, scale=17)
    ...
    @Column(name="number_platforms_blueprints", precision=17, scale=17)
    ...
    @Column(name="number_strategic_initiatives_bp_td", precision=17, scale=17)
    ...
    @Column(name="number_strategic_initiatives_score", precision=17, scale=17)
    ...
    @Column(name="number_strategic_initiatives_weight", precision=17, scale=17)
    ...
    @Column(name="number_strategic_initiatives", precision=17, scale=17)
    ...
    @Column(name="number_strategic_opportunities", precision=17, scale=17)
    ...
    @Column(name="number_strategic_opportunities_bp_td", precision=17, scale=17)
    ...
    @Column(name="number_strategic_opportunities_score", precision=17, scale=17)
    ...
    @Column(name="number_strategic_opportunities_weight", precision=17, scale=17)
    ...
    @Column(name="percentage_portfolio_architecure_impact", precision=17, scale=17)
    ...
    @Column(name="project_cost", precision=17, scale=17)
    ...
    @Column(name="smart_spend_score", precision=17, scale=17)
    ...
    @Column(name="smart_spend_weight", precision=17, scale=17)
    ...
    @Column(name="sqp_impact_cost", precision=17, scale=17)
    ...
    @Column(name="total_smart_spend", precision=17, scale=17)
...
public boolean equals(Object o) {
		 ...
		 if ( (o == null ) )
		 return false;
		 if ( !(o instanceof ScorecardWebform) )
		 return false;

		 ScorecardWebform that = ( ScorecardWebform ) o;
